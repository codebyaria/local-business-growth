...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog post / insight / tip';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['ac-care', 'refrigerator', 'energy', 'maintenance', 'news']
    > &
      Schema.Attribute.DefaultTo<'ac-care'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::article.article'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    readMinutes: Schema.Attribute.Integer &
    ...
    slug: Schema.Attribute.UID<'title.en'> & Schema.Attribute.Required;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Service area (Jakarta Selatan, etc.)';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    region: Schema.Attribute.JSON;
    responseTimeMinutes: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        ...
        number
      >;
    serviceCount: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    slug: Schema.Attribute.UID<'name.en'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Service offering (AC cleaning, gas refill, etc.)';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name.en'> & Schema.Attribute.Required;
    startingPriceIdr: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Singleton settings for site brand, tagline, and contact';
  ...
  attributes: {
    ...
    brand: Schema.Attribute.JSON & Schema.Attribute.Required;
    ...
    primaryLocale: Schema.Attribute.Enumeration<['id', 'en']> & Schema.Attribute.DefaultTo<'id'>;
    publishedAt: Schema.Attribute.DateTime;
    serviceAreas: Schema.Attribute.JSON;
    tagline: Schema.Attribute.JSON & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
