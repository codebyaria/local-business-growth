import {
  ...
  D as s,
  G as ActionNotFoundError,
  H as MiddlewareNoDataOrNextCalled,
  J as MiddlewareNotAResponse,
  K as originPathnameSymbol,
  O as RewriteWithBodyUsed,
  P as GetStaticPathsRequired,
  Q as InvalidGetStaticPathsReturn,
  S as InvalidGetStaticPathsEntry,
  T as GetStaticPathsExpectedParams,
  V as GetStaticPathsInvalidRouteParam,
  W as PageNumberParamNotFound,
  X as DEFAULT_404_COMPONENT,
  Y as NoMatchingStaticPathFound,
  Z as PrerenderDynamicEndpointPathCollide,
  _ as ReservedSlotName,
  $ as renderSlotToString,
  a0 as renderJSX,
  a1 as chunkToString,
  a2 as isRenderInstruction,
  a3 as ForbiddenRewrite,
  a4 as SessionStorageInitError,
  a5 as SessionStorageSaveError,
  a6 as ASTRO_VERSION,
  a7 as CspNotEnabled,
  a8 as LocalsReassigned,
  a9 as generateCspDigest,
  aa as PrerenderClientAddressNotAvailable,
  ab as clientAddressSymbol,
  ac as ClientAddressNotAvailable,
  ad as StaticClientAddressNotAvailable,
  ae as AstroResponseHeadersReassigned,
  af as responseSentSymbol$1,
  ag as renderPage,
  ah as REWRITE_DIRECTIVE_HEADER_KEY,
  ai as REWRITE_DIRECTIVE_HEADER_VALUE,
  aj as renderEndpoint,
  ak as LocalsNotAnObject,
  al as FailedToFindPageMapSSR,
  am as REROUTABLE_STATUS_CODES,
  an as nodeRequestAbortControllerCleanupSymbol,
  ao as getAugmentedNamespace,
  ap as commonjsGlobal,
...
import {
  ...
  e as stringify$2,
  f as ensure404Route,
} from './astro-designed-error-pages_BYjRVJw9.mjs';
...
const dist_es2015$1 = /*#__PURE__*/ Object.freeze(
...
const dist_es2015 = /*#__PURE__*/ Object.freeze(
  /*#__PURE__*/ Object.defineProperty(
    {
      __proto__: null,
      compile,
...
function requireSuperstatic() {
  ...
  const escapeSegment = (str, segmentName) =>
...
function requireServiceRouteOwnership() {
  ...
  function getOwnershipGuard(ownerPrefix, allRoutePrefixes) {
    ...
    const normalizedPrefixes = Array.from(new Set(allRoutePrefixes.map(normalizeRoutePrefix)));
...
function requireDist$1() {
  ...
  (function (module) {
    ...
    const VALID_HANDLE_VALUES = ['filesystem', 'hit', 'miss', 'rewrite', 'error', 'resource'];
...
function requireEncoders() {
  ...
  const hex = (input) =>
    [...new Uint8Array(input)].map((b) => b.toString(16).padStart(2, '0')).join('');
