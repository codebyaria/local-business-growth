...
export {
  fixtureBookings as a,
  fixtureArticles as b,
  fixtureTestimonials as c,
  fixtureLocations as d,
  fixtureServices as f,
  siteSettings as s,
};
